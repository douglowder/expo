...
Pod::Spec.new do |s|
  ...
  s.subspec "Expo" do |ss|
    ...
    ss.ios.dependency         "ABI42_0_0EXFirebaseAnalytics"
    ss.ios.dependency         "ABI42_0_0EXFirebaseCore"
    ss.dependency         "ABI42_0_0EXFont"
    ss.dependency         "EXGL_CPP"
    ss.dependency         "ABI42_0_0EXGL"
    ss.ios.dependency         "ABI42_0_0EXGoogleSignIn"
    ss.ios.dependency         "ABI42_0_0EXHaptics"
